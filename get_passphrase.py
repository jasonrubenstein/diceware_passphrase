...
sys_rand = SystemRandom(os.urandom(1024))
...
def _probable_chaos(werd):
    probability_case = map_target_list[_roll_d100()]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Number of words to generate in the passphrase. Defaults to {}.".format(
            WORDS_TO_GENERATE
        ),
    )
    parser.add_argument(
        ...
        help="Number of passphrases to generate. Defaults to {}.".format(
            PASSPHRASES_TO_GENERATE
        ),
    )
    parser.add_argument(
        "-wf",
